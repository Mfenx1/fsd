...
const getToken = (): string | null => {
  if (typeof window !== 'undefined' && (window as unknown as { __AUTH_TOKEN__?: string | null }).__AUTH_TOKEN__ !== undefined) {
    return (window as unknown as { __AUTH_TOKEN__: string | null }).__AUTH_TOKEN__;
  }
