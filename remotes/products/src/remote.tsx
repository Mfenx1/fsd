...
declare global {
  interface Window {
    __REMOTES_PRODUCTS_ROOTS__?: WeakMap<HTMLElement, ReturnType<typeof createRoot>>;
...
const getRoots = () => {
  ...
  window.__REMOTES_PRODUCTS_ROOTS__ ??= new WeakMap();
  return window.__REMOTES_PRODUCTS_ROOTS__;
};
...
if (typeof window !== 'undefined') {
  ...
  window.__REMOTES__.products = { version, mount, unmount };
}