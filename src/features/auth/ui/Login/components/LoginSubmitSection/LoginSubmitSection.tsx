  ...
  <>
    <div className="relative">
      <button
        type="submit"
        className="
          w-full py-3 px-4 text-base font-semibold bg-blue-600 dark:bg-blue-500 text-white
          border-0 rounded-lg cursor-pointer
          hover:enabled:bg-blue-700 dark:hover:enabled:bg-blue-600
    ...
    <p className="text-center text-sm text-gray-500 dark:text-zinc-400 my-1">или</p>
